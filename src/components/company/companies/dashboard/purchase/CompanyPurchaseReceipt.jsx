...
const CompanyPurchaseReceipt = ({ setClicked, handlePrint, button }) => {

    const purchase = JSON.parse(localStorage.getItem('company-purchase'))
        ...
        <div>
            <div className={`${button ? 'bg-white' : 'bg-color-full'} mx-4 sm:mx-0 pb-10 sm:pb-0`}>
                ...
                <div
                    ...
                    onClick={() => setClicked('CompanyAddNewPurchase')}
                >
...
export default CompanyPurchaseReceipt