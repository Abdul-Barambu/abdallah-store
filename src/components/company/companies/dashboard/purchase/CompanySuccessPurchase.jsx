...
const CompanySuccessPurchase = ({handleAlert, setClicked}) => {
    return (
        <div>
            <div className="proceed-container">
                ...
                <div className='flex flex-col items-center justify-center'>
                    ...
                    {/* button */}
                    <div className='bg-black py-1 px-10 rounded-2xl mb-10' onClick={() => {handleAlert(); setClicked("CompanyPurchaseReceipt")}}>
...
export default CompanySuccessPurchase