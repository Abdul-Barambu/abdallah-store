...
const CompanySalesRecord = ({ setClicked }) => {
    ...
    //     purchase.items.map(item => item.stock_name).toLowerCase().includes(searchValue.toLowerCase())
    // );
    ...
    const handleDeletePurchase = (id) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                axios
                    .delete(`https://aamsheiliagunicorn-sms-wsgi-application.onrender.com/company/stocks/${id}/delete/`, { headers })
                    .then((response) => {
