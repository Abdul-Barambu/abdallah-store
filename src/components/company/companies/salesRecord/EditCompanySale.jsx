...
import EditCompanySalesSuccess from './EditCompanySalesSuccess';

const EditCompanySale = ({ setClicked }) => {
                ...
                alert && (
                    <div className='center-proceed'>
                        ...
                        <div className="center-content-proceed">
                            <EditCompanySalesSuccess handleAlert={handleAlert} setClicked={setClicked} />
                        </div>
                    </div>
                )
            }
...
export default EditCompanySale