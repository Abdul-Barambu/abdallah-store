...
const EditSalesReceipt = ({ setClicked, handlePrint, button }) => {
    return (
        <div>
                ...
                <div className={`bg-white ${button ? 'w-full' : 'w-full sm:w-2/3 lg:w-3/6 xl:w-2/5'} mx-auto pt-0.5 pb-2`}>
                    ...
                    <div className='mt-3'>
                        ...
                        <div className='mx-5 sm:mx-10'>
                            <p className='font-mont text-[11px] sm:text-base font-semibold mb-1'>Customer's Name: Mustapha Isa</p>
                            ...
                            <span className='flex justify-between items-center'>
                                ...
                                <p className='font-mont text-[8px] sm:text-xs black-text font-medium'>Date of Purchase: 2024-10-12</p>
                            </span>
                        </div>
                        {/* middle */}
                        <div>
