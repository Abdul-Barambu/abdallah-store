...
const ViewCompanySalesRecord = ({ setClicked, handlePrint, button }) => {

    const purchase = JSON.parse(localStorage.getItem('ViewCompanyPurchase'));
                ...
                <div className={`bg-white ${button ? 'w-full' : 'w-full sm:w-2/3 lg:w-3/6 xl:w-2/5'} mx-auto pt-0.5 pb-2`}>
                    ...
                    <div className='mt-3'>
                        ...
                        <div className='mx-5 sm:mx-10'>
                            ...
                            <p className='font-mont text-[9px] sm:text-sm font-medium mb-1'>Phone number: {purchase.Customer_name}</p>
                            ...
                            <div className='mx-3 sm:mx-10'>
                                {
                                    purchase.items.map((item, index) => (
                                        <div key={index} className='grid grid-cols-4 text-center py-1.5'>
                                            ...
                                            <span className='font-mont text-[9px] sm:text-xs font-medium'>₦{Number(item.unit_price).toLocaleString()}.00</span>
                                            <span className='font-mont text-[9px] sm:text-xs font-medium'>{item.unit_quantity}</span>
...
export default ViewCompanySalesRecord