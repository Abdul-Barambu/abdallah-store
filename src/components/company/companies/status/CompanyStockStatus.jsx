...
const CompanyStockStatus = ({ setClicked, handlePrint, button }) => {
            ...
            <div className='bg-white pb-32'>
                ...
                <div className={`${button ? '' : 'mt-6 mx-3 sm:mx-0 overflow-x-auto'}`}>
                    ...
                    <div className={`${button ? '' : 'min-w-[600px]'}`}>
                        {/* Head */}
                        <div className='grid grid-cols-4 bg-light-gray py-3 text-center mb-1'>
...
export default CompanyStockStatus