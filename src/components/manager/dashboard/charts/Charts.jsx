...
const Charts = () => {
    ...
    useEffect(() => {
        if (selectedYear) {
            const allSales = () => axios.get("https://aamsheiliagunicorn-sms-wsgi-application.onrender.com/inventory/monthly-sales/", {
                params: {
                    year: selectedYear
                },
                headers: headers
            ...
            const allProfits = () => axios.get("https://aamsheiliagunicorn-sms-wsgi-application.onrender.com/inventory/monthly-profits/", {
                ...
                .then(response => {
                    ...
                    setAprP(response.data.combined_profits.April)
                    setMayP(response.data.combined_profits.May)
                    setJunP(response.data.combined_profits.June)
                    setJulP(response.data.combined_profits.July)
                    setAugP(response.data.combined_profits.August)
                    setSepP(response.data.combined_profits.September)
                    setOctP(response.data.combined_profits.October)
