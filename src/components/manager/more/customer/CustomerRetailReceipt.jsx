        ...
        <div className={`${button ? 'bg-white' : 'bg-color-full'} mx-4 sm:mx-0 pb-10 sm:pb-0`}>
            ...
            <div className={`bg-white ${button ? 'w-full' : 'w-full sm:w-2/3 lg:w-3/6 xl:w-2/5'} mx-auto pt-0.5 pb-2`}>
                ...
                <div className='mt-3'>
                    ...
                    <div>
                        ...
                        <div className='mx-3 sm:mx-10'>
                            ...
                            {/* total */}
                            <p className='text-right text-xs sm:text-sm font-mont font-bold'>Total: ₦{Number(list.total_price).toLocaleString()}</p>
                        </div>
                        ...
                        <div className='mt-10 sm:mt-14 mx-5 sm:mx-10'>
                            <div className='flex items-center justify-between mb-4 sm:mb-5'>
                                ...
                                <p className='text-[10px] sm:text-sm font-mont font-medium'>₦{Number(list.outstanding_balance).toLocaleString()}</p>
                            </div>
                            <div className='flex items-center justify-between mb-5'>
                                <p className='text-[10px] sm:text-sm font-mont font-bold'>Amount Paid:</p>
                                <p className='text-[10px] sm:text-sm font-mont font-bold'>₦{Number(list.amount_paid).toLocaleString()}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className='bg-light-gray mx-2 sm:mx-3 mt-5 text-center py-2'>
                    ...
                    <p className='text-sm sm:text-2xl font-mont font-bold'>{list.payment_status}</p>
                </div>
            </div>
