...
const ViewReceiptRecord = ({ setClicked, handlePrint, button }) => {
            ...
            <div className={`bg-white ${button ? 'w-full' : 'w-full sm:w-2/3 lg:w-3/6 xl:w-2/5'} mx-auto pt-0.5 pb-2`}>
                ...
                <div className='mt-3'>
                    ...
                    <div className='mx-5 sm:mx-10'>
                        <p className='font-mont text-[11px] sm:text-base font-semibold mb-1'>Wholesaler's Name: {list.buyer}</p>
                        ...
                        <span className='flex justify-between items-center'>
                            ...
                            <p className='font-mont text-[8px] sm:text-xs black-text font-medium'>Date of Purchase: {list.date}</p>
                        </span>
                    </div>
                    {/* middle */}
                    <div>
                        ...
                        <div className='mx-3 sm:mx-10'>
                            <div className='grid grid-cols-4 text-center py-4'>
                                <span className='font-mont text-[9px] sm:text-xs font-medium'>{list.name}</span>
                                <span className='font-mont text-[9px] sm:text-xs font-medium'>₦{list.price}</span>
                                <span className='font-mont text-[9px] sm:text-xs font-medium'>{list.qty}</span>
                                <span className='font-mont text-[9px] sm:text-xs font-medium'>₦{list.price * list.qty}</span>
                            </div>
                            {/* total */}
                        ...
                        <div className='mt-10 sm:mt-14 mx-5 sm:mx-10'>
                            <div className='flex items-center justify-between mb-4 sm:mb-5'>
                                ...
                                <p className='text-[10px] sm:text-sm font-mont font-medium'>₦{list.price}</p>
                            </div>
...
export default ViewReceiptRecord
