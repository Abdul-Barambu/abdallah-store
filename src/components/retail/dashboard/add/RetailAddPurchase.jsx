                            ...
                            <span className='py-2 px-4'>
                                <select
                                    ...
                                    onChange={(e) => {
                                        ...
                                        const retailPrice = selectedOption.getAttribute("data-retail-price"); // Retrieve the wholesale price
                                        handleStockSelect(row.id, stockId, retailPrice); // Update the stockPrice for the specific row
                                    }}
                                >
                                    ...
                                    {stocks.map((stock) => (
                                        <option
                                            key={stock.id}
                                            value={stock.id}
                                            data-retail-price={stock.retail_price} // Set the wholesale price as a data attribute
                                        >
                                            {stock.stock_name}
                                        </option>
                                    ))}
