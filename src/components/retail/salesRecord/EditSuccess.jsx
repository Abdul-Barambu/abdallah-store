...
const EditSuccess = ({handleAlert, setClicked}) => {
    return (
        <div>
            <div className="proceed-container">
                ...
                <div className='flex flex-col items-center justify-center'>
                    ...
                    <div className='text-center mt-6 mb-16'>
                        <p className='font-mont font-semibold text-lg mb-4'>Updated Successfully</p>
                        <p className='font-mont text-xs font-medium gray-text'>You can print your receipt below</p>
                    </div>
                    {/* button */}
                    <div className='bg-black py-1 px-10 rounded-2xl mb-10' onClick={() => {handleAlert(); setClicked("EditPurchaseReceipt")}}>
