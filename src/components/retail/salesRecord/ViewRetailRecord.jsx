...
const ViewRetailRecord = ({setClicked, handlePrint, button}) => {
  return (
    <div>
      <div className={`${button ? 'bg-white' : 'bg-color-full'} mx-4 sm:mx-0 pb-10 sm:pb-0`}>
            ...
            <div className={`bg-white ${button ? 'w-full' : 'w-full sm:w-2/3 lg:w-3/6 xl:w-2/5'} mx-auto pt-0.5 pb-2`}>
                ...
                <div className='mt-3'>
                    {/* top */}
                    <div className='mx-5 sm:mx-10 my-7'>
                        {/* <p className='font-mont text-[11px] sm:text-base font-semibold mb-1'>Wholesaler's Name: Abdul Isa</p> */}
                        <p className='font-mont text-[9px] sm:text-sm font-semibold mb-1'>Retail Receipt</p>
...
export default ViewRetailRecord
