                ...
                <div className='py-10 px-48'>
                    ...
                    <div className='mt-7'>
                        ...
                        <div className='mt-7'>
                            ...
                            <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} placeholder='Password' className='mt-2 bg-light-gray w-full text-sm pl-5 py-2 font-mont rounded-xl outline-none' />
                        </div>
                    </div>
