                ...
                <div className='py-10 px-48'>
                    ...
                    <div className='mt-7'>
                        ...
                        <div className='mt-3'>
                            ...
                            <input type="text" value={address} onChange={(e) => setAddress(e.target.value)} placeholder='Address' className='mt-1 bg-light-gray w-full text-sm pl-5 py-2 font-mont rounded-xl outline-none' />
                        </div>
                        <div className='mt-3'>
