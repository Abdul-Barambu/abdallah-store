  ...
  return (
    <div className={`${nav ? 'bg-color-dash' : 'bg-color-full-dash'} pt-3 pb-5`}>
      ...
      < div className='' >
          ...
          <div className='bg-white mx-auto px-7 py-4 rounded-xl dash-width'>
            <div className='flex justify-between items-center'>
              ...
              <div className='flex sm:gap-4 lg:gap-7'>
                <span
                  className={`${(clicked === 'ManagerDashboard' || clicked === 'DueOutstanding') ? 'black-bg text-white' : 'bg-light-gray black-text'} sm:text-[9.5px] lg:text-xs xl:text-sm font-mont font-medium sm:px-6 lg:px-8 xl:px-10 pt-2 pb-[7px] sm:rounded-xl lg:rounded-2xl cursor-pointer`}
        ...
        {/* components */}
        <div className={`mx-4 ${nav ? 'hidden' : 'visible'}`}>
          {
            clicked === 'ManagerDashboard' ? <Cards setClicked={setClicked} /> : clicked === 'DueOutstanding' ? <DueOutstanding setClicked={setClicked} /> : null
          }
        </div>
