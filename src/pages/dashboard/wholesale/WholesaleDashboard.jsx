...
import EditPurchaseReceipt from '../../../components/wholesale/salesRecord/EditPurchaseReceipt'
...
const WholesaleDashboard = () => {
    ...
    const handleLogout = () => {
        Swal.fire({
            ...
            localStorage.removeItem('Wholesale-purchases')
            localStorage.removeItem('access-token')
            localStorage.removeItem('edit-wholesale-purchase')
